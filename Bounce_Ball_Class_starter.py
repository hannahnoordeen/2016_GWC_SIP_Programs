...
image = pygame.image.load("kanye.jpg")

ball_list = []
num_balls = "4000"
while int(num_balls) >= 4000:
	num_balls = input("\n\nHow many balls would you like (don't go over 4000 please): ")
...
# for x in range (random.randint(5, 4000)):		
for x in range (int(num_balls)):	
