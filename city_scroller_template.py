...
front_scroller = Scroller(SCREEN_WIDTH, 100, SCREEN_HEIGHT, FRONT_SCROLLER_COLOR, 3)
middle_scroller = Scroller(SCREEN_WIDTH, 300, (SCREEN_HEIGHT - 50), MIDDLE_SCROLLER_COLOR, 2)
